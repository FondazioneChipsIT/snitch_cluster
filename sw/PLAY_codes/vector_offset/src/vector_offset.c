...
/* Offset the vector src by adding a constant offset_val and save it in src  */

// Snitch runtime library
#include "snrt.h"
#include "data.h"
#include "vect_offset_opt.h"
...
int main(){
    ...
    if(snrt_is_compute_core()){
        ...
        // Call the kernel
        vect_offset_opt(chunk_per_core, offset, &start_cycle[core_idx], &end_cycle[core_idx],
                    src, dst, offset_val);
