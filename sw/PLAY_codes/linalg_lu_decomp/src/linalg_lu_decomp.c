...
int main() {
    ...
    if (snrt_is_dm_core()) {
        ...
        // elems*ncore
        vec_write_back = (double *)(perm_vec + elems);
    ...
    flop_cycle[core_idx] = ((2.0/3.0*elems*elems*elems) + 2*elems*swap_rows_times)/(double)total_cycles[core_idx];
