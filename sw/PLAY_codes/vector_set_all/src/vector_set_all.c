...
/* Set all elements of vector to value val*/

// Snitch runtime library
#include "snrt.h"
#include "data.h"
#include "vect_set_all_opt.h"
...
int main(){
    ...
    if(snrt_is_compute_core()){
        ...
        // Call the kernel
        vect_set_all_opt(chunk_per_core, offset, &start_cycle[core_idx], &end_cycle[core_idx],
                    vec, val);
    ...
    if(core_idx==0){
        ...
        printf("Vector set all %d performance\n",LEN);
