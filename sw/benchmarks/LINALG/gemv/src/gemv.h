...
static inline void single_core_gemv(uint32_t trans, uint32_t m, uint32_t n,
                                    float alpha, float *a, uint32_t lda,
                                    float *x, uint32_t incx, float *y) {
...
static inline void gemv(uint32_t trans, uint32_t m, uint32_t n, float alpha,
                        float *a, float *x, uint32_t incx, float *y) {
