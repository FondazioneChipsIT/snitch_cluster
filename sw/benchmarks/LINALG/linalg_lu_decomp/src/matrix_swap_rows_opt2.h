...
void matrix_swap_rows_opt2(uint32_t chunk_per_core, uint32_t offset, 
    ...
    // Write to ft0
    snrt_ssr_read(SNRT_SSR_DM0, SNRT_SSR_1D, mat_a + indx_a*cols + offset); //ft0<-mat_a
    ...
    snrt_ssr_loop_1d(SNRT_SSR_DM1, chunk_per_core, sizeof(float));
    // Write to ft0
    snrt_ssr_read(SNRT_SSR_DM0, SNRT_SSR_1D, mat_a + indx_b*cols + offset); //ft0<-mat_a
    ...
    snrt_ssr_write(SNRT_SSR_DM1, SNRT_SSR_1D, mat_a + indx_b*cols + offset); //ft1->mat_a
    ...
    snrt_ssr_write(SNRT_SSR_DM1, SNRT_SSR_1D, mat_a + indx_a*cols + offset); //ft1->mat_a
