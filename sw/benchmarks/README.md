...
Launch the simulation of the code, make the traces found in the log folder. Afterwards launch the script performance_parsing.py, it will print the cycles/IPC/FLOP/ for each core and the mean for the cluster. It will also save them in a .txt file for each N and a general .csv with all the runs.
