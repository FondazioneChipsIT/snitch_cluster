...
package snitch_cluster_pkg;
  ...
  localparam int unsigned TcdmSize = 32768;
  localparam int unsigned TcdmSizeNapotRounded = 1 << $clog2(TcdmSize);
  localparam int unsigned BootromSize = 4; // Fixed size of 4kB
  localparam int unsigned ClusterPeriphSize = 508;
  localparam int unsigned ZeroMemorySize = 32256;
  ...
  localparam int unsigned NarrowUserWidth = 53;
  localparam int unsigned WideUserWidth = 48;
  ...
  localparam snitch_ssr_pkg::ssr_cfg_t [3-1:0] SsrCfgs [9] = '{
    '{'{1, 0, 0, 1, 1, 1, 4, 25, 25, 3, 4, 3, 8, 4, 3},
      '{1, 1, 1, 0, 1, 1, 4, 25, 25, 3, 4, 3, 8, 4, 3},
      '{1, 1, 0, 0, 1, 1, 4, 25, 25, 3, 4, 3, 8, 4, 3}},
    '{'{1, 0, 0, 1, 1, 1, 4, 25, 25, 3, 4, 3, 8, 4, 3},
      '{1, 1, 1, 0, 1, 1, 4, 25, 25, 3, 4, 3, 8, 4, 3},
      '{1, 1, 0, 0, 1, 1, 4, 25, 25, 3, 4, 3, 8, 4, 3}},
    '{'{1, 0, 0, 1, 1, 1, 4, 25, 25, 3, 4, 3, 8, 4, 3},
