...
package snitch_cluster_pkg;
  ...
  localparam int unsigned TcdmSize = 1024;
  ...
  localparam int unsigned ZeroMemorySize = 512;
  ...
  localparam snitch_ssr_pkg::ssr_cfg_t [3-1:0] SsrCfgs [9] = '{
    '{'{1, 0, 0, 1, 1, 1, 4, 20, 20, 3, 4, 3, 8, 4, 3},
      '{1, 1, 1, 0, 1, 1, 4, 20, 20, 3, 4, 3, 8, 4, 3},
      '{1, 1, 0, 0, 1, 1, 4, 20, 20, 3, 4, 3, 8, 4, 3}},
    '{'{1, 0, 0, 1, 1, 1, 4, 20, 20, 3, 4, 3, 8, 4, 3},
      '{1, 1, 1, 0, 1, 1, 4, 20, 20, 3, 4, 3, 8, 4, 3},
      '{1, 1, 0, 0, 1, 1, 4, 20, 20, 3, 4, 3, 8, 4, 3}},
    '{'{1, 0, 0, 1, 1, 1, 4, 20, 20, 3, 4, 3, 8, 4, 3},
